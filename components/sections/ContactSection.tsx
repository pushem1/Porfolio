        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Feel free to reach out through the contact form or using the information below. We're always open to discussing new projects, opportunities, or partnerships.
            </p>
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-4 mb-4">
                <a
                  href="https://www.facebook.com/people/Webdz-services/61576440895590/"
                  target="_blank"
